...
<section class="Hui-article-box">
	...
	<form action="{{url('update')}}" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
            ...
            <div  style="overflow: hidden">
                ...
                <div class="info">
                    <div class="pic-box"><img  src="{{asset($Data['dforce2']['pic'])}}">
                        ...
                        <p><input type="text" name="dforce2[title]" value="{{$Data['dforce2']['title']}}"/></p>
                        <span>链接</span>
        ...
        <div class="row cl">
            ...
            <label class="form-label col-xs-4 col-sm-2">编辑：</label>
            <div  style="overflow: hidden">
                <div class="btn btn-secondary" onclick='upload(this,"careers",1)'>修改</div>
                <br/>
                <div class="info">
                    <div class="pic-box"><img  src="{{asset($Data['careers']['pic'])}}">
                        <p class="state">原图</p>
                        <p>title:</p>
                        <input type="hidden" name="careers[pic]" value="{{$Data['careers']['pic']}}">
                        <p><input type="text" name="careers[title]" value="{{$Data['careers']['title']}}"/></p>
                        <span>链接</span>
                        <select name="careers[url]">
                            <?php foreach($url as $v){ ?>
                            <option {{$Data['careers']['url']==$v['url']?'selected':''}} value="{{$v['url']}}">{{$v['title']}}</option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
