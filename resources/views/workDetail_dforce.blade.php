...
@section("content")
    ...
    <div class="wrapper">
        <!-- header -->
        <div class="header">
            <h1 class="logo"><a class="" href="{{ url('index') }}"><img src="{{asset('assets/images/RMA_black.png')}}"/></a></h1>
        ...
        <div id="banner" class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <?php }?>
                <div class="swiper-slide">
                    <a href="{{ url('workDetail') }}" style="background: url({{ cdn_url("assets/images/dforce_04.jpg",1440,900,'!1440x900r') }}) 100% no-repeat; background-size: cover;">
                        <div class="ban-text">
                            <span>D-FROCE</span>
                            <h3 class="pb20">Game <br />is like <br />a macro story<br /><span>遊戲如一場微縮的故事</span></h3>
                        </div>
                    </a>
                </div>
                <div class="swiper-slide">
                    <a href="{{ url('workDetail') }}" style="background: url({{ cdn_url("assets/images/dforce_10.jpg",1440,900,'!1440x900r') }}) 100% no-repeat; background-size: cover;">
                        <div class="ban-text">
                            <span>D-FROCE</span>
                            <h3 class="pb20">Game <br />is like <br />a macro story<br /><span>遊戲如一場微縮的故事</span></h3>
                        </div>
        ...
        <div class="wrap-bg ">
            ...
            <div class="detail-com clearfix" style="overflow:hidden;">
                <div style="width:65%;float:left">
                    ...
                    <video id="dpic" width="100%" src="{{ $Data['honor1'] }}" controls="controls">
                        your browser does not support the video tag
                    </video>
                    {{--<img id="dpic" src="{{ asset('assets/images/xclub_05.jpg') }}" alt="">--}}
                </div>
...
@section("script")
    ...
    <script type="text/javascript">
        ...
        function revise(){
            var height = document.getElementById('dpic').clientHeight/0.89;
