	...
	<form action="{{url('update')}}" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
		...
		<div class="row cl">
			...
			<div>
				...
				<div class="formControls col-xs-8 col-sm-9">
				    <input type="text" name="visiontitle" class="input-text" value="{{$Data['visiontitle']}}">
                    <input type="text" name="content" class="input-text" value="{{$Data['content']}}">
                    <input type="text" name="content_ch" class="input-text" value="{{$Data['content_ch']}}">
                    <input type="text" name="ad_title" class="input-text" value="{{$Data['ad_title']}}">
                    <input type="text" name="cr_desc" class="input-text" value="{{$Data['cr_desc']}}">
                    <input type="text" name="cr_desc_ch" class="input-text" value="{{$Data['cr_desc_ch']}}">
                    <input type="text" name="im_title" class="input-text" value="{{$Data['im_title']}}">
                    <input type="text" name="im_desc" class="input-text" value="{{$Data['im_desc']}}">
                    <input type="text" name="im_desc_ch" class="input-text" value="{{$Data['im_desc_ch']}}">
                    <input type="text" name="di_title" class="input-text" value="{{$Data['di_title']}}">
                    <input type="text" name="di_desc" class="input-text" value="{{$Data['di_desc']}}">
                    <input type="text" name="di_desc_ch" class="input-text" value="{{$Data['di_desc_ch']}}">
				</div>
			</div>
		</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                <?php if($_GET['edit']=='serve'){?>
                <a target="_blank"  href="{{url('serve')}}">打开当前编辑的页面</a>
                <?php }else{?>
