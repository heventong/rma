...
<script type="text/javascript" src="{{ asset("assets/js/hui/jquery.lazyload.js") }}"></script>
    ...
    <div class="row cl">
        ...
        <ul id="upload_pic" style="overflow: hidden">
            ...
            <li class="gray_border" style="float:left;width: 100px;height: 100px;padding: 5px;margin:5px;overflow: hidden">
                <img class="lazy" style="width:100%" title="{{$value}}" data-original="{{asset("assets/images/uploads/$value")}}" data ="assets/images/uploads/{{$value}}">
            </li>
            <?php }?>
            <?php foreach ($image_pic as $value){?>
            <li class="gray_border" style="float:left;width: 100px;height: 100px;padding: 5px;margin:5px;overflow: hidden">
                <img class="lazy" style="width:100%" title="{{$value}}" data-original="{{asset("assets/images/$value")}}" data ="assets/images/{{$value}}">
            </li>
            <?php }?>
            <?php foreach ($cdn as $value){?>
            <li class="gray_border" style="float:left;width: 100px;height: 100px;padding: 5px;margin:5px;overflow: hidden">
                <img class="lazy" style="width:100%" title="{{$value}}" data-original="http://images-1253411363.picgz.myqcloud.com/{{$value}}" data ="http://images-1253411363.picgz.myqcloud.com/{{$value}}">
            </li>
            <?php }?>
        </ul>
</form>
