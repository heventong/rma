	...
	<form action="{{url('update')}}" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
        ...
        <div class="row cl">
            ...
            <div  style="overflow: hidden">
                <div class="btn btn-secondary" onclick='upload(this,"home",1)'>修改</div>
                <br/>
                <div class="info">
                    <div class="pic-box">
                        <img style="width:100%"  src="{{asset($Data['home']['pic'])}}">
                        <p class="state"></p>
                        <input type="hidden"  name="home[pic]"  value="{{$Data['home']['pic']}}">
            ...
            <div>
                ...
                <p><input name="page_title[sub_title]" value="{{$Data['page_title']['sub_title']}}"></p>
            </div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                {{--<a target="_blank"  href="{{url('index')}}">打开当前编辑的页面</a>--}}

                <?php if($_GET['edit']=='homeindex'){?>
                <a target="_blank"  href="{{url('homeindex')}}">打开当前编辑的页面</a>
                <?php }else{?>
