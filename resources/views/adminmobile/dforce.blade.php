...
<section class="Hui-article-box">
	...
	<form action="{{url('update')}}" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
		...
		<input type="hidden" name="page_name" value="workdetaildforce" />
        ...
        <div class="row cl">
            ...
            <div>
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <p><input type="text" name="page_title" value="{{$Data['page_title']}}"></p>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                <a target="_blank"  href="{{url('workDetail?project=dforce')}}">打开当前编辑的页面</a>
			</div>
		</div>
