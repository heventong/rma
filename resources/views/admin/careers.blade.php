    ...
    <section class="Hui-article-box">
        ...
        <form action="{{url('update')}}" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
            ...
            <div class="row cl">
                ...
                <div>
                    <label class="form-label col-xs-4 col-sm-2">页面头编辑：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" name="ti_desc" class="input-text" value="{{$Data['ti_desc']}}">
                        <input type="text" name="ti_desc_ch" class="input-text" value="{{$Data['ti_desc_ch']}}">
                        <input type="text" name="in_title" class="input-text" value="{{$Data['in_title']}}">
                        <input type="text" name="se_title" class="input-text" value="{{$Data['se_title']}}">
                        <input type="text" name="de_title" class="input-text" value="{{$Data['de_title']}}">
                        <input type="text" name="ju_title" class="input-text" value="{{$Data['ju_title']}}">
                        <input type="text" name="ju1_title" class="input-text" value="{{$Data['ju1_title']}}">
                        <input type="text" name="ff_title" class="input-text" value="{{$Data['ff_title']}}">
                        <input type="text" name="de1_title" class="input-text" value="{{$Data['de1_title']}}">
                        <input type="text" name="ju2_title" class="input-text" value="{{$Data['ju2_title']}}">
            ...
            <div class="row cl">
                ...
                <div  style="overflow: hidden">
                    <div class="btn btn-secondary" onclick='upload(this,"person1",1,1)'>修改</div>
                    <br/>
                    <div class="info">
                        <div class="pic-box"><img  src="{{asset($Data['person1']['pic'])}}">
                            <p class="state">原图</p>
                            <input type="hidden" name="person1[pic]" value="{{$Data['person1']['pic']}}">
                            <input type="text" name="person1[title]" value="{{$Data['person1']['title']}}">
                            <input type="text" name="person1[sub_title]" value="{{$Data['person1']['sub_title']}}">
                        </div>
                    </div>
                </div>
            ...
            <div class="row cl">
                ...
                <label class="form-label col-xs-4 col-sm-2">编辑：</label>
                <div  style="overflow: hidden">
                    <div class="btn btn-secondary" onclick='upload(this,"person2",1,1)'>修改</div>
                    <br/>
                    <div class="info">
                        <div class="pic-box"><img  src="{{asset($Data['person2']['pic'])}}">
                            <p class="state">原图</p>
                            <input type="hidden" name="person2[pic]" value="{{$Data['person2']['pic']}}">
                            <input type="text" name="person2[title]" value="{{$Data['person2']['title']}}">
                            <input type="text" name="person2[sub_title]" value="{{$Data['person2']['sub_title']}}">
                        </div>
                    </div>
                </div>
            ...
            <div class="row cl">
                ...
                <label class="form-label col-xs-4 col-sm-2">编辑：</label>
                <div  style="overflow: hidden">
                    <div class="btn btn-secondary" onclick='upload(this,"person3",1,1)'>修改</div>
                    <br/>
                    <div class="info">
                        <div class="pic-box"><img  src="{{asset($Data['person3']['pic'])}}">
                            <p class="state">原图</p>
                            <input type="hidden" name="person3[pic]" value="{{$Data['person3']['pic']}}">
                            <input type="text" name="person3[title]" value="{{$Data['person3']['title']}}">
                            <input type="text" name="person3[sub_title]" value="{{$Data['person3']['sub_title']}}">
                        </div>
                    </div>
                </div>
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                    ...
                    <?php if($_GET['edit']=='careers'){?>
                    <a target="_blank"  href="{{url('careers')}}">打开当前编辑的页面</a>
                    <?php }else{?>
        ...
        function set_upload(upload_value,type,count=0,link_type=0) {
            ...
            if(count == 1){
                var contact = "<div class='pic-box upload_pic'><input name='"+upload_value.name+"[pic]' type='hidden' value='"+upload_value.value+"'>" +
                        ...
                        "<p>title_ch:<input type='text' name='"+upload_value.name+"[sub_title]' value='"+tmp['data'][type]['sub_title']+"'></p>";
                result+=contact;
                return result;
            }
