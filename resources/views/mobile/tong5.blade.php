...
.detail-com {
    ...
    <div class="wrapper">
        ...
        <div class="wrap-bg">
            ...
            <div class="detail-com  clearfix" style="height: 7rem">
                <img class="pct120" src="{{ $Data['workdetail2'] }}" alt="">
                <div style="width:40%;height:4px;position: relative;top: -3.5rem;float: right;background-color:white;overflow:hidden;"></div>
            ...
            <div class="detail-com clearfix " style="height: 7rem">
                ...
                <div style="width:40%;height:4px;position: relative;top: -3.5rem;float: left;background-color:white;overflow:hidden;"></div>
                <div style="float:left;width: 4px;height: 47em;background: white;position: relative;top: -47em;left: 0em;"></div>
            </div>
            <div class="detail-com clearfix ">
                <img class="pct120" src="{{ $Data['workdetail6'] }}" alt="">
            </div>
<!--
		...
		{{--<video width="100%" src="{{url('assets/images/video.mp4')}}" controls="controls">--}}
		{{--您的浏览器不支持 video 标签。--}}
		{{--</video>--}}
