...
<input type="hidden" id="lang_name" value="{{$lang_name}}">
<section class="Hui-article-box">
	...
	<form action="{{url('update')}}" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" >
		...
		<div class="row cl">
            ...
            <label class="form-label col-xs-4 col-sm-2">修改：</label>
            <div  style="overflow: hidden">
            ...
            <div  style="overflow: hidden">
                ...
                <div class="info">
                    <div class="pic-box"><img  src="{{asset($Data['songclub']['pic'])}}">
                        ...
                        <p><input type="text" name="songclub[title]" value="{{$Data['songclub']['title']}}"/></p>
                        <span>链接</span>
        ...
        <div class="row cl">
            ...
            <label class="form-label col-xs-4 col-sm-2">修改：</label>
            <div  style="overflow: hidden">
                <div class="btn btn-secondary" onclick='upload(this,"songclub_award",1)'>修改</div>
                <br/>
                <div class="info">
                    <div class="pic-box"><img  src="{{asset($Data['songclub_award']['pic'])}}">
                        <p class="state">原图</p>
                        <p>title:</p>
                        <input type="hidden" name="songclub_award[pic]" value="{{$Data['songclub_award']['pic']}}">
                        <p><input type="text" name="songclub_award[title]" value="{{$Data['songclub_award']['title']}}"/></p>
                        <span>链接</span>
                        <select name="songclub_award[url]">
                            <?php foreach($url as $v){ ?>
                            <option {{$Data['songclub_award']['url']==$v['url']?'selected':''}} value="{{$v['url']}}">{{$v['title']}}</option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
        ...
        <div class="row cl">
            ...
            <label class="form-label col-xs-4 col-sm-2">修改：</label>
            <div  style="overflow: hidden">
                <div class="btn btn-secondary" onclick='upload(this,"dforce_award",1)'>修改</div>
                <br/>
                <div class="info">
                    <div class="pic-box"><img  src="{{asset($Data['dforce_award']['pic'])}}">
                        <p class="state">原图</p>
                        <p>title:</p>
                        <input type="hidden" name="dforce_award[pic]" value="{{$Data['dforce_award']['pic']}}">
                        <p><input type="text" name="dforce_award[title]" value="{{$Data['dforce_award']['title']}}"/></p>
                        <span>链接</span>
                        <select name="dforce_award[url]">
                            <?php foreach($url as $v){ ?>
                            <option {{$Data['dforce_award']['url']==$v['url']?'selected':''}} value="{{$v['url']}}">{{$v['title']}}</option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
            ...
            <div  style="overflow: hidden">
                ...
                <div class="info">
                    <div class="pic-box"><img  src="{{asset($Data['songrestaurant']['pic'])}}">
                        ...
                        <p><input type="text"  name="songrestaurant[title]" value="{{$Data['songrestaurant']['title']}}"/></p>
                        <span>链接</span>
            ...
            <div  style="overflow: hidden">
                ...
                <div class="info">
                    <div class="pic-box"><img  src="{{asset($Data['cave']['pic'])}}">
                        ...
                        <p><input type="text" name="cave[title]" value="{{$Data['cave']['title']}}"/></p>
                        <span>链接</span>
            ...
            <div  style="overflow: hidden">
                ...
                <div class="info">
                    <div class="pic-box"><img  src="{{asset($Data['xclub']['pic'])}}">
                        ...
                        <p><input type="text" name="xclub[title]" value="{{$Data['xclub']['title']}}"/></p>
                        <span>链接</span>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                ...
                <a target="_blank"  href="{{url('home')}}">打开当前编辑的页面</a>
                <?php }else{?>
